...
namespace BravoMarket.DAL.Migrations
{
    ...
    [Migration("20230909191738_AddCategoryProductTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.Footer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.FooterAbout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.Header", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.Law", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.LeftNavigation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.Other", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.RightNavigation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.SocialMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.Category", b =>
                {
                    b.HasOne("BravoMarket.DAL.Entities.Category", "ParentCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.Company", b =>
                {
                    b.HasOne("BravoMarket.DAL.Entities.Footer", "Footer")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.LeftNavigation", b =>
                {
                    b.HasOne("BravoMarket.DAL.Entities.Header", "Header")
                        .WithMany("LeftNavigations")
            ...
            modelBuilder.Entity("CategoryProduct", b =>
                {
                    b.HasOne("BravoMarket.DAL.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BravoMarket.DAL.Entities.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.Header", b =>
                {
                    b.Navigation("LeftNavigations");

                    b.Navigation("RightNavigations");
                });
