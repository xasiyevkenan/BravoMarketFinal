...
namespace BravoMarket.DAL.Migrations
{
    ...
    [Migration("20230826143749_AddContactTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.ClientFAQ", b =>
                {
                    b.HasOne("BravoMarket.DAL.Entities.Contact", "Contact")
                        .WithOne("ClientFAQ")
                        .HasForeignKey("BravoMarket.DAL.Entities.ClientFAQ", "ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BravoMarket.DAL.Entities.ConsumerProtection", b =>
                {
                    b.HasOne("BravoMarket.DAL.Entities.Contact", "Contact")
                        .WithOne("ConsumerProtection")
                        .HasForeignKey("BravoMarket.DAL.Entities.ConsumerProtection", "ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
