        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LittleImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SliderDots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SliderDots_IndexSliders_IndexSliderId",
                        column: x => x.IndexSliderId,
                        principalTable: "IndexSliders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SliderDots_IndexSliderId",
                table: "SliderDots",
                column: "IndexSliderId",
                unique: true);
        }
